...
If you need to change the role for a principal, Pulumi handles the delete-then-create automatically. Be aware that there may be a brief window during which the principal holds neither the old nor the new role.
